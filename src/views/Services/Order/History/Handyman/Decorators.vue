<template>
  ...
  <BackBtn class="mx-5" />
    ...
    <span v-for="app in store.applications(
      HANDYMAN_SERVICE_TYPE, HANDYMAN_DECORATOR_CATEGORY
    )">
        <div
            ...
            @click="openForm(app)"
        >
            {{ app.date + ' ' + app.time + ', ' + app.address + ', ' + app.worker_total }} чел
        </div>
    </span>
</template>
